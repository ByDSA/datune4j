...
export class ChromaticUtils {
    static fromDiatonicAlt(diatonicAlt) {
    ...
    static toStringParams(chromatic) {
...
ChromaticUtils.NUMBER = 12;
//# sourceMappingURL=ChromaticUtils.js.map
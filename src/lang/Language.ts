...
export class Language {
    ...
    static ENG: LanguageInterface = {
        id: "ENG",
        diatonic: {
            get C(): string { return Language.CUSTOM.diatonic.C || "C" },
            get D(): string { return Language.CUSTOM.diatonic.D || "D" },
            get E(): string { return Language.CUSTOM.diatonic.E || "E" },
            get F(): string { return Language.CUSTOM.diatonic.F || "F" },
            get G(): string { return Language.CUSTOM.diatonic.G || "G" },
            get A(): string { return Language.CUSTOM.diatonic.A || "A" },
            get B(): string { return Language.CUSTOM.diatonic.B || "B" },
        },
        scales: {
            MAJOR: "MAJOR",
            MINOR: "MINOR",
        ...
        temperaments: {
            get ET12(): string { return Language.CUSTOM.temperaments.ET12 || "12-ET" },
            get LIMIT_5_SYMMETRIC_N1(): string { return Language.CUSTOM.temperaments.LIMIT_5_SYMMETRIC_N1 || "5-LIMIT: SN1" },
            get LIMIT_5_SYMMETRIC_N2(): string { return Language.CUSTOM.temperaments.LIMIT_5_SYMMETRIC_N2 || "5-LIMIT: SN2" },
            get PYTHAGOREAN(): string { return Language.CUSTOM.temperaments.PYTHAGOREAN || "Pythagorean" },
        },
        words: {
            get note(): string { return Language.CUSTOM.words.note || "note" },
            get chord(): string { return Language.CUSTOM.words.chord || "chord" },
            get scale(): string { return Language.CUSTOM.words.scale || "scale" },
            get tonality(): string { return Language.CUSTOM.words.tonality || "tonality" },
            get tuning(): string { return Language.CUSTOM.words.tuning || "tuning" },
            get temperament(): string { return Language.CUSTOM.words.temperament || "temperament" },
            get degreeFunction(): string { return Language.CUSTOM.words.degreeFunction || "degree function" },
            get degree(): string { return Language.CUSTOM.words.degree || "degree" },
            get pitch(): string { return Language.CUSTOM.words.pitch || "pitch" },
            get pattern(): string { return Language.CUSTOM.words.pattern || "pattern" },
            get inversion(): string { return Language.CUSTOM.words.inversion || "inversion" },
            get root(): string { return Language.CUSTOM.words.root || "root" },
            get diatonicAlt(): string { return Language.CUSTOM.words.diatonicAlt || "altered diatonic note" },
            get diatonic(): string { return Language.CUSTOM.words.diatonic || "diatonic note" },
            get chromatic(): string { return Language.CUSTOM.words.chromatic || "chromatic note" },
        }
    }
    ...
    static ESP: LanguageInterface = {
        id: "ESP",
        diatonic: {
            get C(): string { return Language.CUSTOM.diatonic.C || "Do" },
            get D(): string { return Language.CUSTOM.diatonic.D || "Re" },
            get E(): string { return Language.CUSTOM.diatonic.E || "Mi" },
            get F(): string { return Language.CUSTOM.diatonic.F || "Fa" },
            get G(): string { return Language.CUSTOM.diatonic.G || "Sol" },
            get A(): string { return Language.CUSTOM.diatonic.A || "La" },
            get B(): string { return Language.CUSTOM.diatonic.B || "Si" },
        },
        scales: {
            MAJOR: "MAYOR",
            MINOR: "MENOR",
        ...
        temperaments: {
            get ET12(): string { return Language.CUSTOM.temperaments.ET12 || "12-Temperamento Igual" },
            get LIMIT_5_SYMMETRIC_N1(): string { return Language.CUSTOM.temperaments.LIMIT_5_SYMMETRIC_N1 || Language.ENG.temperaments.LIMIT_5_SYMMETRIC_N1 },
            get LIMIT_5_SYMMETRIC_N2(): string { return Language.CUSTOM.temperaments.LIMIT_5_SYMMETRIC_N2 || Language.ENG.temperaments.LIMIT_5_SYMMETRIC_N2 },
            get PYTHAGOREAN(): string { return Language.CUSTOM.temperaments.PYTHAGOREAN || "Pitagórico" },
        },
        words: {
            get note(): string { return Language.CUSTOM.words.note || "nota" },
            get chord(): string { return Language.CUSTOM.words.chord || "acorde" },
            get scale(): string { return Language.CUSTOM.words.scale || "escala" },
            get tonality(): string { return Language.CUSTOM.words.tonality || "tonalidad" },
            get tuning(): string { return Language.CUSTOM.words.tuning || "afinación" },
            get temperament(): string { return Language.CUSTOM.words.temperament || "temperamento" },
            get degreeFunction(): string { return Language.CUSTOM.words.degreeFunction || "función tonal" },
            get degree(): string { return Language.CUSTOM.words.degree || "grado" },
            get pitch(): string { return Language.CUSTOM.words.pitch || "pitch" },
            get pattern(): string { return Language.CUSTOM.words.pattern || "patrón" },
            get inversion(): string { return Language.CUSTOM.words.inversion || "inversión" },
            get root(): string { return Language.CUSTOM.words.root || "raíz" },
            get diatonicAlt(): string { return Language.CUSTOM.words.diatonicAlt || "nota diatónica alterada" },
            get diatonic(): string { return Language.CUSTOM.words.diatonic || "nota diatónica" },
            get chromatic(): string { return Language.CUSTOM.words.chromatic || "nota chromática" },
        }
    }

		...
		public void load(Tonality ton) {
			...
			for ( CustomChromaticChord c1 : cs ) {
				...
				if ( !c.getTonality().equals( ton ) ) {
					if (ArrayUtils.contained( c.getFunction(), ChromaticFunction.TENSIONS))
 ...
 * 
 * add(Chord.VI).inv(2); // F# A D I-III-VI VI 2ª inv
 * 
 ...
 * c2.add(pre + Note.V1*3 + Note.V8 + Note.V8*2, new NoteScale(1, octave, s,

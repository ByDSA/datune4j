...
import datastructures.EnumTreeSet;
...
public enum ChromaticChordEnum implements PitchChromaticChord<Chromatic> {
	...
	public static final EnumSet<ChromaticChordEnum>	UNUSUAL_CHORDS			= SetUtils.of( 
		CHORDS_SUSb2,
		CHORDS_SUSa4,
		CHORDS_SUSb2b5
			);

	public static final EnumSet<ChromaticChordEnum>	TRIAD_CHORDS		= SetUtils.of(
		CHORDS_MAJOR,
		CHORDS_MINOR,
		CHORDS_DIMINISHED,
		CHORDS_AUGMENTED,
	...
	public static final EnumSet<ChromaticChordEnum>	SEVENTH_CHORDS			= SetUtils.of(
		CHORDS_7,
		CHORDS_Maj7,
		CHORDS_m7,
		CHORDS_7b5,
	...
	public static final EnumSet<ChromaticChordEnum>	SIXTH_CHORDS	= SetUtils.of(
		CHORDS_6,
		CHORDS_m6,
		CHORDS_6sus4,
		CHORDS_6add9,
	...
	public static final EnumSet<ChromaticChordEnum>	NINTH_CHORDS		= SetUtils.of(
		CHORDS_7b9,
		CHORDS_7a9,
		CHORDS_m7b9,
		CHORDS_9,
	...
	public static final EnumSet<ChromaticChordEnum>	ELEVENTH_CHORDS			= SetUtils.of(
		CHORDS_11,
		CHORDS_m11,
		CHORDS_11b9,
		CHORDS_11a9,
	...
	public static final EnumSet<ChromaticChordEnum>	THIRTEENTH_CHORDS		= SetUtils.of(
		CHORDS_m13,
		CHORDS_13sus4,
		CHORDS_13b5,
		CHORDS_13a5,
	...
	public static final EnumSet<ChromaticChordEnum>	PARTIAL_CHORDS			= SetUtils.of(
		CHORDS_FIFTH
			);

	public static final EnumSet<ChromaticChordEnum>	COMMON_CHORDS	= SetUtils.of(TRIAD_CHORDS, SEVENTH_CHORDS, SIXTH_CHORDS, NINTH_CHORDS, ELEVENTH_CHORDS, THIRTEENTH_CHORDS, PARTIAL_CHORDS);
	...
	@Override
	public PitchChromaticChord<Chromatic> over(Chromatic c) throws ImpossibleChord {
		CustomChromaticChord dup = CustomChromaticChord.copyOf( this );
		for(int i = 0; i < size(); i++) {
			if ( dup.get(0).val() == c.val() )
				return dup;
			if (i < size()-1)
				dup = dup.inv();
		}
	...
	@Override
	public <T extends ChordInterface<Chromatic>> List<T> getAllInversions() {
	...
	public <T extends ChordInterface<Chromatic>> T removeHigherDuplicates() {
		CustomChromaticChord dup = new CustomChromaticChord();
		return dup.removeHigherDuplicates();
	}

	@Override
	public CustomChromaticChord add(int pos, Chromatic... ns) throws AddedException {
		CustomChromaticChord dup = new CustomChromaticChord();
		return dup.add( ns );
	}

	@Override
	public CustomChromaticChord add(Chromatic... cs) throws AddedException {
		CustomChromaticChord dup = new CustomChromaticChord();
		return dup.add( cs );
	}

	@Override
	public <T extends ChordInterface<Chromatic>> T add(ChordInterface<Chromatic> cs) throws AddedException {
		CustomChromaticChord dup = new CustomChromaticChord();
		return dup.add( cs );
	}

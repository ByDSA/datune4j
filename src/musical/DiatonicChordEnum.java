...
public enum DiatonicChordEnum implements PitchDiatonicChord<Diatonic> {
	...
	private DiatonicChordEnum(Diatonic... cs) {
		assert cs != null;		
	...
	public List<CustomDiatonicChord> getAllInversions() {
		return new CustomDiatonicChord(this).getAllInversions();
	}
	...
	public CustomDiatonicChord setRoot(int n) {
		return new CustomDiatonicChord(this).setRoot( n );
	}
	...
	@Override
	public <T extends ChordInterface<Diatonic>> T add(ChordInterface<Diatonic> cs) throws AddedException {
		return new CustomDiatonicChord(this).add( cs );
	}
}

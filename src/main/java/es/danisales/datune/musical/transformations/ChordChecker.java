...
public class ChordChecker {
    ...
    public static <N extends Chord> boolean hasSameNotesOrder(N notes1, N notes) {
    ...
    public static <N extends Chord> boolean hasSameNotesOrder(N notes1, boolean sameOctave, N notes) {
